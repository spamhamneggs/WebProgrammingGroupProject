        ...
        <>
            ...
            <Layout>
                ...
                <header className="relative pt-10 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
                    <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-nature-200 rounded-full blur-3xl opacity-50 mix-blend-multiply animate-blob">
                    </div>
                    <div className="absolute top-0 left-0 -ml-20 mt-40 w-72 h-72 bg-earth-300 rounded-full blur-3xl opacity-50 mix-blend-multiply animate-blob animation-delay-2000">
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
                        ...
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold text-nature-900 leading-tight mb-6">
                            ...
                            <span className="text-nature-600 italic relative">
                                Grow Together.
                                <svg
                                    className="absolute w-full h-3 -bottom-1 left-0 text-nature-300/50"
                                    viewBox="0 0 200 9"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                >
                                    <path
                                        d="M2.00025 6.99997C58.5002 3.99999 147.5 -2.50002 198 2.99997"
                                        stroke="currentColor"
                                        strokeWidth="3"
                                    />
                                </svg>
                        ...
                        <p className="mt-4 max-w-2xl mx-auto text-xl text-nature-700/80 leading-relaxed font-light">
                            A community marketplace where talent is the
                            currency. No money changes hands, just genuine
                            exchange and local partnerships.
                        </p>
                        ...
                        <div className="mt-10 max-w-3xl mx-auto relative z-10">
                            ...
                            <p className="mt-3 text-sm text-nature-600">
                                Popular:{" "}
                                <span className="underline decoration-nature-400 cursor-pointer">
                                    Web Design
                                </span>,{" "}
                                <span className="underline decoration-nature-400 cursor-pointer">
                                    Photography
                        ...
                        <div className="grid grid-cols-12 gap-4 items-center opacity-90">
                            <div className="col-span-3 col-start-2 transform translate-y-8">
                                <img
                                    ...
                                    alt="Meeting"
                                    className="rounded-2xl shadow-lg border-4 border-white -rotate-2"
                                />
                            </div>
                            ...
                            <div className="col-span-3 transform translate-y-6">
                                <img
                                    ...
                                    alt="Baker"
                                    className="rounded-2xl shadow-lg border-4 border-white rotate-3"
                                />
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-20 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            ...
                            <p className="mt-4 text-nature-600 max-w-2xl mx-auto">
                                No complex currencies. Just people helping
                                people.
                            </p>
                        </div>

                        <div className="grid md:grid-cols-3 gap-12 relative">
                            <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-0.5 bg-nature-200 border-t-2 border-dashed border-nature-300 z-0">
                            </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                <p className="text-nature-100 text-lg leading-relaxed mb-6 font-light">
                                    ...
                                    . By removing financial barriers, we empower
                                    students, freelancers, and small businesses
                                    (UMKM) to access the essential skills they
                                    need to grow.
                                </p>
                                <ul className="space-y-4">
                                    <li className="flex items-start">
                                        <CheckCircle2
                                            size={24}
                                            className="text-nature-300 mr-3 mt-0.5 flex-shrink-0"
                                        />
                                        <span className="text-nature-50">
                            ...
                            <div className="relative">
                                <div className="absolute -inset-4 bg-nature-600/30 rounded-2xl transform rotate-6">
                                </div>
                                <img
                                    src="https://images.unsplash.com/photo-1531545514256-b1400bc00f31?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                                    alt="Community Impact"
                                    className="relative rounded-2xl shadow-2xl border-2 border-nature-600"
                                />
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-20 bg-earth-200">
                    <div className="max-w-4xl mx-auto px-4 text-center">
                        <h2 className="text-4xl font-display font-bold text-nature-900 mb-6">
                            Ready to Swap?
                        </h2>
                        <p className="text-xl text-nature-700 mb-10 font-light">
                            Join thousands of community members trading skills
