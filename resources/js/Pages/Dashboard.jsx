                        ...
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            {auth.user?.role === 'admin' && (
                                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
                                    <p className="text-blue-700 font-medium mb-2">Admin Dashboard</p>
                                    <p className="text-blue-600 mb-4">As an admin, you have special privileges to manage users and content.</p>
                                    <a
                                        href="/admin/users"
                            ...
                            <div className="mt-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    ...
                                    {auth.user?.role === 'admin' && (
                                        <a
                                            href="/admin/users"
                                            className="bg-blue-100 hover:bg-blue-200 p-4 rounded-lg transition duration-300 border border-blue-200"
                                        >
